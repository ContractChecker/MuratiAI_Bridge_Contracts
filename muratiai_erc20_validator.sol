...
contract Validator is Context, Ownable {
    ...
    string private _name = "MURATIAI Validator";
    string private _symbol = "MURATIAI Validator";
    ...
    function setRequiredValidations(
        uint256 _requiredValidations
    ) public onlyOwner {
        require(
            _requiredValidations > 0,
            "Error: Required validations must be greater than 0"
        );
    ...
    function transfer(
        ...
        require(
            bridge.validNonce(fromChainID, _txNonce) == 0,
        ...
        require(
            !transfers[request].validators[_msgSender()],
